...
execute at @s unless entity @p[distance=..16,predicate=quinnsbetternoteblocks:holding_wrench] run function quinnsbetternoteblocks:gamelogic/interactions/interaction_shrink
