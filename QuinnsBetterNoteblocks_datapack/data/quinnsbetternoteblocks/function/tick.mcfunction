...
execute as @a at @s if predicate quinnsbetternoteblocks:holding_wrench run execute as @e[type=minecraft:interaction,distance=..15,tag=nb_interaction,tag=inactive] at @s run function quinnsbetternoteblocks:gamelogic/interactions/interaction_grow
