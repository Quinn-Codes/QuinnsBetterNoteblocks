...
execute align xyz positioned ~0.5 ~ ~0.5 unless entity @e[type=interaction,tag=nb_interaction,distance=..0.25] run function quinnsbetternoteblocks:actions/upgrade/check_above